    ...
    return(
        <section id="about" className = "py-20">
            <motion.div
                ...
                <p className="text-center leading-snug text-base md:text-lg mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-sm">B.S. in Mathematics (2025)</p>
          </div>

          {/* NEU logo */}
          <div className="flex flex-col items-center">
            <img src={northeasternLogo} alt="Grad School" className="h-40 object-contain" />
            <p className="mt-2 text-sm">M.S. in Data Science (exp. 2027)</p>
          </div>
        </div>
      </motion.div>
    </section>
